...
export default function App() {
  ...
  // Usamos uma View simples (nao o SafeAreaProvider) para o callback
  // onLayout que esconde a splash screen - e o padrao mais confiavel,
  // pois nem toda versao repassa onLayout para a View nativa interna.
