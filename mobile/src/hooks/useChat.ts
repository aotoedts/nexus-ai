 ...
 * cai automaticamente para uma chamada HTTP tradicional.
 */
export function useChat(conversationId: string | undefined) {
  ...
  useEffect(() => {
    ...
    apiClient.get(`/conversations/${conversationId}/messages`).then((res) => setMessages(res.data.messages)).finally(() => setIsLoadingHistory(false));
  }, [conversationId]);
