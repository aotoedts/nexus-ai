...
export function ChatInputBar({ onSend, disabled }: Props) {
  ...
  return (
    <View style={styles.container}>
      <TextInput value={value} onChangeText={setValue} placeholder="Escreva sua mensagem..." placeholderTextColor={colors.text.muted} style={styles.input} multiline editable={!disabled} />
      <TouchableOpacity onPress={handleSend} disabled={!value.trim() || disabled} style={[styles.sendButton, (!value.trim() || disabled) && styles.sendButtonDisabled]}>
