...
- **App mobile**: instalável como PWA (Android/iOS, hoje) e empacotável como app nativo Android/iOS via Capacitor, com build automático de `.apk` via GitHub Actions — veja [`docs/MOBILE.md`](docs/MOBILE.md).
